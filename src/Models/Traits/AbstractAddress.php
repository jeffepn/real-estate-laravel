...
{
    public static $columnsAddress = ['address', 'number', 'not_number', 'complement', 'cep', 'longitude', 'latitude'];
    public static $columnsCreateUpdateNeighborhood = ['neighborhood', 'city', 'state', 'initials', 'country'];
    ...
    private function updateNeighborhood(array $data): Neighborhood
    {
        ...
        return Arr::has($data, ['neighborhood'])
